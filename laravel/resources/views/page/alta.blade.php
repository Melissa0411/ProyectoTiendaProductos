...
<input type="text" aria-label="First name" class="form-control" name="clave" style="margin-right: 20px">
</div>
<div class="input-group">
<span class="input-group-text" style="margin-left: 60px"> NOMBRE:</span>
<input type="text" aria-label="First name" class="form-control" name="nombre" style="margin-right: 20px">
</div>
<div class="input-group">
  <span class="input-group-text" style="margin-left: 60px">APELLIDO  MATERNO</span>
  <input type="text" aria-label="First name" class="form-control" name="app" >

  <span class="input-group-text"style="margin-left: 20px"> APELLIDO PATERNO</span>
  <input type="text" aria-label="LApellido Paterno" class="form-control" name="ap">
</div>
<div class="input-group" id="lom">
<span class="input-group-text">
FECHA DE NACIMIENTO</span>
 <input type="date" name="fn"></div>
...
<input type="file" name="foto" id="">
  ...
  <input type="text"  name="email" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" style="margin-right: 20px">
  <div class="input-group mb-3">
    </div><br>

  <span class="input-group-text" id="basic-addon1" style="margin-left: 60px">Contraseña</span>
  <input type="text" name="pass" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" style="margin-right: 20px">
</div>

<div class="input-group mb-3" id="comit">
                    <span class="input-group-text" id="basic-addon1" style="margin-left: 15px">NIVEL</span>
                    <button type="button" class="btn btn-success" >  <input type="checkbox" name="nivel" checked></button> 
                </div>
                <div class="input-group mb-3" id="comit">
