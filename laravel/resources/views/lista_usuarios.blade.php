...
@section('content')
<a href="{{  route('alta_usuarios') }}"> 
<button style="background-color:#FAB9F3;  border-radius:22px; border:3px solid #FAB9F3;" type="submit"> Agregar Usuario</button> </a>
<br>
<table class="table table-striped table-hover">  <thead>
    <tr>
      ...
      <th scope="col" style="color: #591C68">Fecha de Nacimiento</th>
      <th scope="col" style="color: #591C68">Gmail</th>
...
<td>
<a href="{{route('borrar_usuarios',['id' => $usuario->id_usuario]) }}" onclick="return confirm(' BORRAR  USUARIO')">
...
<button type = "button" style="background-color:#FAB9F3;  border-radius:22px; border:3px solid #FAB9F3;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
